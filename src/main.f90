program sdfgenerator
  ...
  call compute_scalar_distance(sx,ex,sy,ey,sz,ez,num_vertices,vertices,pointinside)  
  ...
  call get_signed_distance(num_faces,numberofnarrowpoints,faces,vertices,directions,narrowbandindices,pointinside)
  ...
  close(10)
  ! Write points where SDF is tagged with a sign
  open(unit=11, file='data/narrowbandpoints.bin', status='replace', form='unformatted')
  write(11) numberofnarrowpoints
  write(11) narrowbandindices
  close(11)
